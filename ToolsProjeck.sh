...
echo $red ">>"   $blue "5.Tools TU4N G4L4U"    $cyan "|———|"
echo $red ">>"   $blue "6.Toolss B4J1N64N"
echo $red ">>"   $blue "7.Tools TUAN B4DUT"    $cyan "|———|"
...
echo $red ">>"   $white "11.Hack Wifi(Root)"   $cyan "|———|"
echo $red ">>"   $white "12.Creator Deface"
echo $purple "____________________________"    $cyan "|———|"
echo					       $cyan "| T |"
echo					       $cyan "| E |"
echo $purple "____________________________"    $cyan "| R |"
